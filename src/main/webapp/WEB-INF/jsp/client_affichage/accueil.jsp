        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center gap-2">
                    <span class="text-2xl font-bold text-brand-600">Shoes</span>
                    <span class="text-gray-400">|</span>
                    <span class="text-gray-600 font-medium">Boutique</span>
                </div>
                    ...
                    <div class="p-5 flex-1 flex flex-col">
                        ...
                        <div class="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between gap-4">
                            <div class="flex flex-col">
                                <div class="text-2xl font-black text-brand-600">${v.prix} €</div>
