        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
            <div class="container mx-auto max-w-2xl">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                    <form:form action="/${basePath}/enregistrer" method="POST" modelAttribute="item" class="space-y-6">
                        <form:hidden path="id" />
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4">
                            <a href="/${basePath}" class="px-6 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors shadow-sm">
                                Annuler
                            </a>
