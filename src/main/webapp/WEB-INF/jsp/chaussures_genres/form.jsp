                    ...
                    <form:form action="/chaussures-genres/enregistrer" method="POST" modelAttribute="item" class="space-y-6">
                        ...
                        <div>
                            <label for="prix" class="block text-sm font-semibold text-gray-700 mb-2">
                                Prix (Ar)
                                <span class="text-xs font-normal text-gray-500 ml-1 italic">(Optionnel, héritera du modèle si vide)</span>
                            </label>
                            <form:input path="prix" id="prix" class="w-full px-4 py-2 rounded-md border border-gray-300 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition-all" placeholder="Ex: 129.99" />
